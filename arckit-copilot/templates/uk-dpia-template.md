...
> **Template Origin**: Official | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk:uk-dpia`
...
If YES, also complete `/arckit-uk:uk-ai-playbook` and `/arckit-uk:uk-atrs` assessments.
...
**Generated by**: ArcKit `/arckit-uk:uk-dpia` command
**Generated on**: [DATE]
