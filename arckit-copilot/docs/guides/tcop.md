...
`/arckit-uk:uk-tcop` generates a Technology Code of Practice (TCoP) review document for UK Government technology projects.
...
```bash
/arckit-uk:uk-tcop Create TCoP review for <project>
```
...
| Compliance | Create TCoP review | `/arckit-uk:uk-tcop` |
