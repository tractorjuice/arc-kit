...
`/arckit-uk:uk-gov-code-search` provides general-purpose natural language search across 24,500+ UK government open-source repositories, returning matching repositories, patterns, and implementation approaches without requiring an active project.
...
```bash
/arckit-uk:uk-gov-code-search <query>
```
...
- Run `/arckit-uk:uk-gov-reuse` to perform a full scored reuse assessment for a specific project
...
## Comparison with /arckit-uk:uk-gov-reuse and /arckit-uk:uk-gov-landscape

| Feature | `/arckit-uk:uk-gov-code-search` | `/arckit-uk:uk-gov-reuse` | `/arckit-uk:uk-gov-landscape` |
|---------|--------------------------|--------------------|-----------------------|
...
**Workflow**: Use `/arckit-uk:uk-gov-code-search` for quick discovery, `/arckit-uk:uk-gov-reuse` for project-specific reuse decisions, and `/arckit-uk:uk-gov-landscape` for domain-level situational awareness.
