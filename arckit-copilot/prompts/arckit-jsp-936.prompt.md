...
After the JSP 936 assessment, add:

**JSP 936 Compliance Score**: Calculate percentage of JSP 936 requirements met. Score = met / total × 100%.

**Control-to-Threat Traceability**: Map each JSP 936 control to the defence threat(s) it mitigates.
