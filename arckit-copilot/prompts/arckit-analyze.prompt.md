...
- Project for MOD but no SbD assessment (MANDATORY to run `/arckit-uk-mod:uk-mod-secure`)
...
1. **If CRITICAL issues exist**: ❌ **DO NOT PROCEED** with implementation/procurement until resolved.
   ...
   - Run: `/arckit-uk:uk-ai-playbook` (if UK Gov AI system) to complete mandatory assessments
...
**For UK Government projects (governance_framework = UK Gov)**:
- `/arckit-uk:uk-tcop` - Complete TCoP assessment for UK Gov projects
- `/arckit-uk:uk-ai-playbook` - Complete AI Playbook assessment for AI systems
- `/arckit-uk:uk-atrs` - Generate ATRS record for algorithmic tools
- `/arckit-uk:uk-secure` - UK Government Secure by Design review
- `/arckit-uk:uk-service-assessment` - GDS Service Assessment readiness

**For MOD projects (governance_framework = UK Gov, MOD)**:
- `/arckit-uk-mod:uk-mod-secure` - MOD Secure by Design assessment with CAAT (MANDATORY for MOD projects)
...
- `/arckit-uk:uk-tcop` - Complete TCoP assessment
- `/arckit-uk:uk-ai-playbook` - Complete AI Playbook assessment
- `/arckit-uk:uk-atrs` - Generate ATRS record
- `/arckit-uk:uk-secure` - UK Government Secure by Design review
- `/arckit-uk:uk-service-assessment` - GDS Service Assessment readiness

**For MOD projects (governance_framework = UK Gov, MOD)**:

- `/arckit-uk-mod:uk-mod-secure` - MOD Secure by Design assessment with CAAT
