...
5. Resolve the `<!-- DOC-CONTROL-HEADER -->` marker per `RENDERING.md`. Use the Australian classification scheme where classification applies: UNOFFICIAL / OFFICIAL / OFFICIAL:Sensitive / PROTECTED / SECRET.
