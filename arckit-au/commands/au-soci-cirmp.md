...
5. Resolve the `<!-- DOC-CONTROL-HEADER -->` marker per `RENDERING.md`. Note that SOCI protected information is not the same as PSPF PROTECTED classification; document both where relevant.
