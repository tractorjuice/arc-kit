...
4. **Read existing artifacts from the project context:**
   ...
   **Read the template** (with user override support):
   - **First**, check if `.arckit/templates/uk-atrs-template.md` exists in the project root
   - **If found**: Read the user's customized template (user override takes precedence)
   - **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/uk-atrs-template.md` (default)
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/arckit-uk:uk-atrs` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/arckit-uk:uk-atrs` command
...
User: `/arckit-uk:uk-atrs Generate ATRS record for our benefits eligibility chatbot using GPT-4`
...
- **AI Playbook** - responsible AI deployment (use `/arckit-uk:uk-ai-playbook` first for AI systems)
- **Technology Code of Practice** - broader technology governance (use `/arckit-uk:uk-tcop`)
