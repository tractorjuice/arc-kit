...
- **First**, check if `.arckit/templates/uk-service-assessment-template.md` exists in the project root
- **If found**: Read the user's customized template (user override takes precedence)
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/uk-service-assessment-template.md` (default)
...
Before writing the file, read `${CLAUDE_PLUGIN_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **SVCASS** per-type checks pass. Fix any failures before proceeding.
...
- [ ] Re-run `/arckit-uk:uk-service-assessment` command weekly to track progress
...
**Weekly**:
- [ ] Re-run `/arckit-uk:uk-service-assessment PHASE=[phase]` to track progress
...
**Overlap with TCoP**:
- `/arckit-uk:uk-tcop` - Technology Code of Practice assessment (points 11, 13 overlap)
...
- `/arckit-uk:uk-secure` - If security assessment incomplete
...
**Report Generated by**: ArcKit v{ARCKIT_VERSION} `/arckit-uk:uk-service-assessment` command

**Next Actions**:
1. Review this report with your team
2. Prioritize critical actions in your sprint planning
3. Re-run `/arckit-uk:uk-service-assessment PHASE=[phase]` weekly to track progress
...
```text
/arckit-uk:uk-service-assessment PHASE=alpha DATE=2025-12-15
```

Generates: `projects/001-nhs-appointment/ARC-001-SVCASS-v1.0.md`

```text
/arckit-uk:uk-service-assessment PHASE=beta
```
