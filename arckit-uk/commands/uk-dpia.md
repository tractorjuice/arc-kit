...
- **First**, check if `.arckit/templates/uk-dpia-template.md` exists in the project root
- **If found**: Read the user's customized template (user override takes precedence)
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/uk-dpia-template.md` (default)
...
11. **AI/ML Systems**: If the system uses AI/ML for profiling, automated decision-making, or algorithmic processing, integrate with `/arckit-uk:uk-ai-playbook` assessment and link to ATRS record.
...
```text
/arckit-uk:uk-dpia Generate DPIA for NHS appointment booking system

/arckit-uk:uk-dpia Create data protection impact assessment for HMRC chatbot handling taxpayer queries

/arckit-uk:uk-dpia Assess DPIA necessity for Windows 11 deployment (employee data only)
```
