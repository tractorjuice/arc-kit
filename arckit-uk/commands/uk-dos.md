...
- **First**, check if `.arckit/templates/uk-dos-template.md` exists in the project root
- **If found**: Read the user's customized template (user override takes precedence)
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/uk-dos-template.md` (default)
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/arckit-uk:uk-dos` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/arckit-uk:uk-dos` command
...
- **Wrong framework**: If user mentions G-Cloud or cloud services, suggest `/arckit-uk:uk-gcloud-search` instead
