...
> **Template Origin**: Official | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk:uk-service-assessment`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [DATE] | ArcKit AI | Initial creation from `/arckit-uk:uk-service-assessment` command | PENDING | PENDING |
...
- [ ] Re-run `/arckit-uk:uk-service-assessment` weekly
...
- [ ] Re-run `/arckit-uk:uk-service-assessment PHASE=[phase]` weekly
...
**Generated by**: ArcKit `/arckit-uk:uk-service-assessment` command
**Generated on**: [DATE]
