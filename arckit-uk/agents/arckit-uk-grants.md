...
description: 'Use this agent when the user needs to research UK funding opportunities
  ...
  user: "/arckit-uk:uk-grants Research funding opportunities for the NHS appointment booking
  project"
...
1. **Read the template** (with user override support):
   ...
   - **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/uk-grants-template.md` (default)
...
- **Templates** — `${CLAUDE_PLUGIN_ROOT}/templates/uk-grants-template.md` (override at `.arckit/templates-custom/grants-template.md`)
