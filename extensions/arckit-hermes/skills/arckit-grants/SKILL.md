...
Triggers: "/arckit:grants", "arckit-grants", "Research UK government grants, charitable funding, and accel".
...
- `ARC-*-REQ-*.md` in `projects/{project}/` — Requirements specification
  ...
  - If missing: warn user to run `/arckit:requirements` first, but proceed using `{topic}` as the project description
