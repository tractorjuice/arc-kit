...
Triggers: "/arckit:competitors", "arckit-competitors", "Competitor landscape — rival suppliers, awarded-value market".
...
using the explicit scope in `{topic}` and say so in your first message
