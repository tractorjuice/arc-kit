...
# ArcKit Business Capability Map

## When to Use

Triggers: "/arckit:business-capability-map", "arckit-business-capability-map", "Map business capabilities, value streams, and maturity for P".
