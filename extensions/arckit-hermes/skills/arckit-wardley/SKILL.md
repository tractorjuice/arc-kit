...
Triggers: "/arckit:wardley", "arckit-wardley", "Create strategic Wardley Maps for architecture decisions and".
...
1a. **Tidy OWM labels** — *only if `--tidy-owm` was passed in `{topic}`*. Rewrite the
