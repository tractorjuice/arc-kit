...
Triggers: "/arckit:start", "arckit-start", "Get oriented with ArcKit — guided project onboarding, workfl".
...
2. If the user provided `{topic}` with a specific focus (e.g., "procurement", "governance review"), use that as context during triage — it may let you skip some questions
