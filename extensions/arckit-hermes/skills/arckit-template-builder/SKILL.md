...
Triggers: "/arckit:template-builder", "arckit-template-builder", "Create new document templates by interviewing the user about".
...
Extract the template type from `{topic}`. If blank or vague, ask the user what kind of document template they want to create.
