...
Triggers: "/arckit:score", "arckit-score", "Score vendor proposals against evaluation criteria with pers".
...
Parse the first word of `{topic}` to determine which action to perform:
