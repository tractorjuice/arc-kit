...
# ArcKit Agent Inventory

## When to Use

Triggers: "/arckit:agent-inventory", "arckit-agent-inventory", "Catalog existing AI agents with capabilities, security class".
...
1. **Determine inventory scope**:
   ...
   Use the user's input and `{topic}` to determine scope.
