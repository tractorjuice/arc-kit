...
# ArcKit Transition Architecture

## When to Use

Triggers: "/arckit:transition-architecture", "arckit-transition-architecture", "Plan transition architectures with work packages, migration ".
