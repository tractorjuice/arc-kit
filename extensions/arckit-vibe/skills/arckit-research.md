...
Before writing the file, read `${VIBE_EXTENSION_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **RSCH** per-type checks pass. Fix any failures before proceeding.

6. Write to `projects/{project-dir}/research/ARC-{PROJECT_ID}-RSCH-v1.0.md` using Write tool
