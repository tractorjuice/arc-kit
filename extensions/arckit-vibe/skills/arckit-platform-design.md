...
display_name: ArcKit Platform Design
...
- **If not found**: Read `${VIBE_EXTENSION_ROOT}/templates/platform-design-template.md` (default)
...
Before writing the file, read `${VIBE_EXTENSION_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **PLAT** per-type checks pass. Fix any failures before proceeding.
