...
display_name: ArcKit Wardley.Value Chain
...
Read `${VIBE_EXTENSION_ROOT}/skills/wardley-mapping/references/evolution-stages.md` for supporting context on component characteristics.
...
- **If not found**: Read `${VIBE_EXTENSION_ROOT}/templates/wardley-value-chain-template.md` (default)
