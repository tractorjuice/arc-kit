...
export const DOC_TYPES = {
  ...
  // Australian Federal / DISP-supplier Overlay (Community-contributed, maintained by @royster70)
  // Anchored on ASD Essential Eight + ISM, DTA Digital Service Standard, Privacy Act 1988 + 13 APPs,
