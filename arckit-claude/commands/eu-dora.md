---
description: Assess DORA (Digital Operational Resilience Act, EU 2022/2554) compliance for financial sector entities operating in the EU
argument-hint: "<project ID or entity type, e.g. '001', 'French payment institution migrating to cloud'>"
effort: high
handoffs:
  - command: eu-nis2
    description: Map overlapping NIS2 cybersecurity obligations for financial entities designated as OSE
    condition: "Entity is also subject to NIS2 as an operator of essential services"
  - command: risk
    description: Integrate DORA ICT risk findings and third-party concentration risks into the risk register
  - command: secure
    description: Implement technical security controls addressing DORA ICT risk management requirements
---
...
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/eu-dora-template.md`
