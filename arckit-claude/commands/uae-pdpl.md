...
2. Read the template:
   ...
   - **Fallback**, `${CLAUDE_PLUGIN_ROOT}/templates/uae-pdpl-template.md`
3. Use `scripts/bash/generate-document-id.sh <PROJECT_ID> PDPL --filename` for the artefact filename.
