---
description: Assess EU AI Act (Regulation 2024/1689) compliance obligations, risk classification, and conformity requirements for AI systems
argument-hint: "<project ID or AI system description, e.g. '001', 'automated CV screening tool for public employment service'>"
effort: high
handoffs:
  - command: eu-rgpd
    description: Assess GDPR obligations for personal data used in AI training or inference
    condition: "AI system processes personal data"
  - command: risk
    description: Integrate AI Act compliance gaps and prohibited practice findings into the risk register
  - command: traceability
    description: Link AI Act conformity requirements back to functional requirements
    condition: "High-risk AI system classification confirmed"
---
...
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/eu-ai-act-template.md`
