---
description: "[EXPERIMENTAL] Assess EU Data Act (Regulation 2023/2854) compliance for connected products, data holders, and data processing service providers"
argument-hint: "<project ID or product/service description, e.g. '001', 'industrial IoT platform with smart sensor data'>"
effort: high
handoffs:
  - command: eu-rgpd
    description: Assess GDPR obligations for personal data in the data sharing flows
    condition: "Data sharing includes personal data"
  - command: fr-marche-public
    description: Include Data Act data sharing obligations in procurement clauses
    condition: "Data sharing involves public sector bodies or procurement"
  - command: risk
    description: Integrate Data Act compliance gaps and data sharing risks into the risk register
---
...
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/eu-data-act-template.md`
