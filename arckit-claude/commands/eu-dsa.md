---
description: Assess EU Digital Services Act (DSA, Regulation 2022/2065) compliance obligations for online intermediary services, platforms, and very large online platforms
argument-hint: "<project ID or service description, e.g. '001', 'online marketplace with 50M EU users'>"
effort: high
handoffs:
  - command: eu-rgpd
    description: Assess GDPR obligations for personal data processed in recommender systems, advertising, and content moderation
    condition: "Service processes personal data of EU users"
  - command: eu-ai-act
    description: Assess AI Act obligations for recommender systems and automated content moderation
    condition: "Service uses AI for recommendation or content moderation decisions"
  - command: risk
    description: Integrate DSA compliance gaps and systemic risk findings into the risk register
    condition: "VLOP or VLOSE designation applies"
---
...
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/eu-dsa-template.md`
