...
7. Populate the External References section per `${CLAUDE_PLUGIN_ROOT}/references/citation-instructions.md`. DTA AI Policy v2.0, AU AI Ethics Principles, ISO 42001 (Australian Standard), Privacy Act 1988 MUST appear in the Document Register.
