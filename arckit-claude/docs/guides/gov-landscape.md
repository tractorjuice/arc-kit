...
`/arckit-uk:uk-gov-landscape` maps what UK government has built in a domain — organisations active in the space, common technology patterns, adopted standards, maturity levels, and collaboration opportunities — giving architects a broad situational picture before making design decisions.
...
```bash
/arckit-uk:uk-gov-landscape <domain>
```
...
- Run `/arckit-uk:uk-gov-reuse` to perform a scored reuse assessment for specific capabilities identified in the landscape
...
## Comparison with /arckit-uk:uk-gov-reuse and /arckit-uk:uk-gov-code-search

| Feature | `/arckit-uk:uk-gov-landscape` | `/arckit-uk:uk-gov-reuse` | `/arckit-uk:uk-gov-code-search` |
|---------|------------------------|--------------------|--------------------------|
...
**Workflow**: Use `/arckit-uk:uk-gov-landscape` to understand the domain, `/arckit-uk:uk-gov-code-search` for targeted queries, and `/arckit-uk:uk-gov-reuse` for project-specific reuse decisions.
