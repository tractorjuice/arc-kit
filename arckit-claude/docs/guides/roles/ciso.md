...
|---------|---------|-------|
| `/arckit-uk:uk-secure` | Review Secure by Design assessments across projects | [Guide](#docs/guides/secure.md) |
| `/arckit-uk-mod:uk-mod-secure` | Review MOD Secure by Design assessments (if MOD) | [Guide](#docs/guides/mod-secure.md) |
| `/arckit-uk:uk-dpia` | Oversee DPIAs for data protection compliance | [Guide](#docs/guides/dpia.md) |
...
| `/arckit-uk:uk-ai-playbook` | Review AI safety and security controls | [Guide](#docs/guides/ai-playbook.md) |
| `/arckit-uk-mod:uk-mod-jsp-936` | Review MOD AI assurance (if applicable) | [Guide](#docs/guides/jsp-936.md) |
...
3. **Review assessments**: Review `/arckit-uk:uk-secure` or `/arckit-uk-mod:uk-mod-secure` outputs
