...
`/arckit-uk-mod:uk-mod-secure` generates a Ministry of Defence Secure by Design assessment using CAAT and continuous assurance methodology.
...
```bash
/arckit-uk-mod:uk-mod-secure Create MOD Secure by Design assessment for <system>
```
...
| Assessment | Create MOD SbD assessment | `/arckit-uk-mod:uk-mod-secure` |
