---
name: arckit-uk-service-assessment
...
- **First**, check if `.arckit/templates-custom/uk-service-assessment-template.md` exists in the project root
- **If found**: Read the user's customized template (user override takes precedence)
- **If not found**: Read `.arckit/templates/uk-service-assessment-template.md` (default)
