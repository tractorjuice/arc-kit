...
- **First**, check if `.arckit/templates-custom/uk-mod-secure-template.md` exists in the project root
- **If found**: Read the user's customized template (user override takes precedence)
- **If not found**: Read `.arckit/templates/uk-mod-secure-template.md` (default)
