...
3. **Read existing artifacts from the project context:**
   ...
   **Read the template** (with user override support):
   - **First**, check if `.arckit/templates-custom/uk-ai-playbook-template.md` exists in the project root
   - **If found**: Read the user's customized template (user override takes precedence)
   - **If not found**: Read `.arckit/templates/uk-ai-playbook-template.md` (default)
...
- `[COMMAND]` → "arckit-uk:uk-ai-playbook"
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/arckit-uk:uk-ai-playbook` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/arckit-uk:uk-ai-playbook` command
...
User: `/arckit-uk:uk-ai-playbook Assess AI Playbook compliance for benefits eligibility chatbot using GPT-4`
