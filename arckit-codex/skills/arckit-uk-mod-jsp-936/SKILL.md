...
- **First**, check if `.arckit/templates-custom/uk-mod-jsp-936-template.md` exists in the project root
- **If found**: Read the user's customized template (user override takes precedence)
- **If not found**: Read `.arckit/templates/uk-mod-jsp-936-template.md` (default)
