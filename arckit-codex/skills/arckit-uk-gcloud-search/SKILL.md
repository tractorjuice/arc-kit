...
- `[COMMAND]` → "arckit-uk:uk-gcloud-search"
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/arckit-uk:uk-gcloud-search` command | [PENDING] | [PENDING] |
```
...
- **Custom development detected**: ERROR "This is for custom development - use /arckit-uk:uk-dos instead"
...
✅ Use /arckit-uk:uk-dos instead - Digital Outcomes and Specialists
...
Only use /arckit-uk:uk-gcloud-search if you need:
