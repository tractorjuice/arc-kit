...
effort: high
handoffs:
  - command: business-capability-map
    description: Map business capabilities within the defined scope
  - command: gap-analysis
    description: Perform gap analysis based on scope and vision
---
