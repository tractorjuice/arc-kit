...
handoffs:
  - command: gap-analysis
    description: Analyze capability gaps against target state
  - command: application-inventory
    description: Map applications to capabilities
---
