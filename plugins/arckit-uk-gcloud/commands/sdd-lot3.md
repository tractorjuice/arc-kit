...
### Next Steps
- Produce the pricing document (detailed rate card) for this service: `/arckit:pricing`
- Generate NCSC Cloud Security Principles assertions / clearances: `/arckit:security`
