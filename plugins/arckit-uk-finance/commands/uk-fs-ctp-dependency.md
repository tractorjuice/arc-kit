...
- `${CLAUDE_PLUGIN_ROOT}/templates/uk-fs-ctp-dependency-template.md` — master artefact template
- `${CLAUDE_PLUGIN_ROOT}/templates/uk-fs-ctp-dependency-register-template.md` — per-provider
