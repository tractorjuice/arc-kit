...
ArcKit needs Claude Code **v2.1.280 or later** (see Prerequisites below). The simplest way to land on a supported version — even if you've never installed Claude Code before — is:
...
- **Claude Code** v2.1.280 or later (recommended minimum)
