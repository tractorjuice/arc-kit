...
handoffs:
  - command: service-assessment
    description: GC Digital Standards conformance feeds the broader service assessment evidence base.
  - command: roadmap
    description: Identified gaps and remediation actions become roadmap milestones.
---
