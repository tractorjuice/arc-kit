...
> planning aid for a UK G-Cloud / Digital Marketplace **Lot 1 (Cloud Hosting)** service offering; it
...
> certificates, data-centre specifications) before publishing a live framework listing.

You are helping a cloud service supplier generate a complete **Service Definition Document (SDD)** for
**Lot 1 (Cloud Hosting — IaaS / PaaS)** on the G-Cloud Digital Marketplace.
...
- **Supplier website / infrastructure page** — data-centre specifications, network connectivity
  options (PSN, HSCN), infrastructure certifications, sustainability / PUE metrics, security
  certifications.
- **Existing Digital Marketplace listing** —
  `site:applytosupply.digitalmarketplace.service.gov.uk "[service name]" "Lot 1"` to see how the
  service is currently described, existing pricing tiers, and infrastructure specifications.
...
Use the **Read tool** to read the Lot 1 template:

- `${CLAUDE_PLUGIN_ROOT}/templates/sdd-lot1-template.md`
...
Generate answers for **all** questions in the template. Lot 1 (Cloud Hosting) carries additional
infrastructure-focused questions on top of the categories shared with the other lots (Security,
Support, Operations, Data, Pricing, Resilience, Standards & Certifications, End of Service). Use the
service design and supplier profile to provide accurate, **consistent** answers.

**CRITICAL:** The SDD must answer every mandatory question — missing answers cause rejection.

#### Lot 1 specific categories
...
- Virtualisation technology used
- Hypervisor details
...
- Public sector network connectivity (PSN, HSCN, etc.)
...
`**G-Cloud Lot**` line — record this service as **Lot 1 (Cloud Hosting)**. Respect marketplace
...
**Generated by**: ArcKit `/arckit-uk-gcloud:sdd-lot1` command
**Generated on**: [DATE]
...
### Key Differentiators
- UK Sovereign: [Yes/No]
- PSN Connected: [Yes/No]
- HSCN Connected: [Yes/No]
- GPU Available: [Yes/No]

### Certifications
- ISO 27001: [Certificate #]
- SOC 2 Type II: [Yes/No]
- Data Centre Tier: [III/IV]

### Next Steps
- Produce the pricing document for this service: `/arckit-uk-gcloud:pricing`
- Generate NCSC Cloud Security Principles assertions: `/arckit-uk-gcloud:security`
...
- Lot 1 buyers often require PSN / HSCN connectivity — be clear about capabilities.
- Data-centre location and sovereignty is critical for many buyers.
- Infrastructure certifications (Tier levels) must be evidenceable.
- Performance metrics should be measurable and auditable.
- Every assertion must be evidenceable — CCS may request proof; data-centre locations and
  certifications must match the supplier profile.
