...
- Service Definition Document — `{path}/ARC-{PROJECT_ID}-SDD-v*.md` (written by `/arckit-uk-gcloud:sdd-lot1`,
  `/arckit-uk-gcloud:sdd-lot2`, or `/arckit-uk-gcloud:sdd-lot3`)
...
- A missing document is a blocking finding; name the command that produces it (`/arckit-uk-gcloud:sdd-lot1`,
  `/arckit-uk-gcloud:pricing`, `/arckit-uk-gcloud:security`, `/arckit-uk-gcloud:supplier-profile`, `/arckit-uk-gcloud:declaration`).
