...
### Next Steps
- Benchmark this pricing against Digital Marketplace rivals: `/arckit-uk-gcloud:gcloud-competitors`
...
- [If the service design or supplier profile was missing: run `/arckit-uk-gcloud:service-design` /
  `/arckit-uk-gcloud:supplier-profile` to enrich this pricing document]
```
