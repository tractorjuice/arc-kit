...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk-finance:uk-fs-ctp-dependency`
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | {{CREATED_DATE}} | ArcKit AI | Initial creation from `/arckit-uk-finance:uk-fs-ctp-dependency` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-uk-finance:uk-fs-ctp-dependency` command
**Generated on**: [DATE]
