...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk-finance:uk-fs-safeguarding`
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | {{CREATED_DATE}} | ArcKit AI | Initial creation from `/arckit-uk-finance:uk-fs-safeguarding` command | PENDING | PENDING |
...
> assessed in the firm's CTP dependency register. Use `/arckit-uk-finance:uk-fs-ctp-dependency` to produce
> that assessment.
