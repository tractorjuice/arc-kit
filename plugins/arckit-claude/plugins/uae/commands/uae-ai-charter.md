...
4. Use `scripts/bash/generate-document-id.sh <PROJECT_ID> AICH --filename` for the artefact filename.
...
- The Human Oversight principle interacts directly with the AI Autonomy Tier Posture (AUTI) — recommend `/arckit-uae:uae-ai-autonomy-tier` as a follow-up where the system has any non-deterministic decision authority.
