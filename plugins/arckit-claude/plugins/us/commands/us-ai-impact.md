...
handoffs:
  - command: us-ai-rmf
    description: The minimum-practice gaps surfaced here drive the AI RMF Govern / Map / Measure / Manage uplift backlog.
  - command: us-privacy-pia
    description: Rights-impacting AI systems handling PII require an E-Gov Act §208 PIA.
  - command: risk
    description: Residual M-24-10 risks (especially where minimum practices cannot be met) flow into the risk register.
---
...
1. Read prerequisites:
   ...
   - The project's AI RMF artefact (recommended prerequisite — if absent, suggest running `/arckit-us:us-ai-rmf` first)
...
Minimum-practice gaps drive the AI RMF uplift backlog via `/arckit-us:us-ai-rmf`. PII-handling AI systems require `/arckit-us:us-privacy-pia`. Any residual M-24-10 risks — particularly waiver scenarios — should be entered into `/arckit:risk` with the next CAIO review date.
