...
|---------|------|--------|-------------|----------|----------|
| `[VERSION]` | `[YYYY-MM-DD]` | ArcKit AI | Initial creation from `/arckit-togaf-adm:architecture-change` command | `[REVIEWER_NAME]` | `[APPROVER_NAME]` |
...
**Generated by**: ArcKit `/arckit-togaf-adm:architecture-change` command
