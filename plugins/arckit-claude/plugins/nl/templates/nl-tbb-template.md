...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-nl:nl-tbb`
>
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-nl:nl-tbb` | [PENDING] | [PENDING] |
...
| Feeds `/arckit-nl:nl-cloud` clause 5.2 eligibility check | [Yes — reference this document] |
| Feeds `/arckit-nl:nl-bio` control prioritisation | [Yes — reference this document] |

**Next steps**: Run `/arckit-nl:nl-cloud` if cloud hosting is under consideration for this system. Run `/arckit:risk` to reflect the determined category in the risk register.

---

**Generated by**: ArcKit `/arckit-nl:nl-tbb` command
