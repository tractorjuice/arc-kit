...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-au-energy:au-energy-compliance`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-au-energy:au-energy-compliance` command | PENDING | PENDING |
...
| Command | `/arckit-au-energy:au-energy-compliance` |
...
**Generated by**: ArcKit `/arckit-au-energy:au-energy-compliance` command
**Generated on**: [DATE]
