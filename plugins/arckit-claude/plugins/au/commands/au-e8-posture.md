...
- The Essential Eight is a **mitigation** framework, not a comprehensive security standard. Recommend `/arckit-au:au-ism-controls` for the full ISM control applicability statement.
