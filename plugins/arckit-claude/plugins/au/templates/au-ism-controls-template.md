...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-au:au-ism-controls`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-au:au-ism-controls` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-au:au-ism-controls` command
**Generated on**: [DATE]
