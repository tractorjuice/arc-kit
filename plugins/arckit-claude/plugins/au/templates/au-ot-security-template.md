...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-au:au-ot-security`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-au:au-ot-security` command | PENDING | PENDING |
...
| Does this trigger `/arckit-au:au-ai-assurance`? | [Yes / No] | [Reason] |
...
**Generated by**: ArcKit `/arckit-au:au-ot-security` command
**Generated on**: [DATE]
