...
handoffs:
  - command: fr-secnumcloud
    description: Assess SecNumCloud qualification for sovereign cloud hosting
    condition: "RES-6 (Technological Resilience) or RES-5 (Supply-Chain) reveals critical cloud dependency gaps"
  - command: eu-rgpd
    description: Full GDPR compliance assessment for RES-2 regulatory gaps
    condition: "RES-2 (Economic and Legal Resilience) identifies GDPR compliance gaps"
  - command: eu-nis2
    description: NIS2 compliance assessment for essential/important entity obligations
    condition: "RES-2 or RES-7 identifies NIS2 obligations"
  - command: fr-anssi
    description: ANSSI hygiene assessment for RES-7 cybersecurity gaps
    condition: "RES-7 (Security Resilience) reveals significant gaps"
  - command: fr-ebios
    description: EBIOS risk study for operational resilience gaps
    condition: "RES-4 (Operational Resilience) reveals significant risk management gaps"
---
...
{If cloud gaps: 4. Run /arckit-fr:fr-secnumcloud for sovereign hosting assessment}
{If GDPR gaps: 5. Run /arckit-eu:eu-rgpd for full data compliance assessment}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```text
/arckit-fr:fr-irn IRN self-assessment for project 001 — AI-driven HR SaaS platform using AWS eu-west-3 with US-based sub-processors

/arckit-fr:fr-irn Assess IRN for a French bank running on Azure with Microsoft 365 across 5,000 employees

/arckit-fr:fr-irn IRN scaffold for a public hospital group — 3 sites, OVHcloud infrastructure, Epic HRIS, strong open-source policy
```
