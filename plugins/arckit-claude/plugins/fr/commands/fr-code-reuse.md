...
handoffs:
  - command: fr-marche-public
    description: If no reusable code found, generate procurement documentation to source the component
    condition: "Build-vs-reuse decision concludes that procurement is required for one or more components"
  - command: research
    description: Research commercial and open source market alternatives for components with no public code match
    condition: "No public code reuse candidate found and a technology selection decision is needed"
  - command: fr-dinum
    description: Align code reuse and open source decisions with DINUM doctrine obligations
    condition: "Project is a French public administration IS subject to DINUM circulaire on open source"
---
...
- **If not found**: Read `${CLAUDE_PLUGIN_ROOT}/templates/fr-code-reuse-template.md`
- **Then read** `${CLAUDE_PLUGIN_ROOT}/templates/_partials/RENDERING.md` and resolve the `<!-- DOC-CONTROL-HEADER -->` marker in the template before writing. `REUSE` carries the France regime, which hard-routes to `_partials/document-control-fr.md` (Non protégé / Diffusion Restreinte / Secret / Très Secret) whatever the operator's user config says.
...
- **Procure**: No suitable public code exists; proceed to procurement via `/arckit-fr:fr-marche-public`
...
Before writing the file, read `${CLAUDE_PLUGIN_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus **REUSE** per-type checks pass.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Next steps:
1. {If procurement needed: Run /arckit-fr:fr-marche-public for components requiring sourcing}
2. {If technology selection needed: Run /arckit:research for market alternatives}
3. Run /arckit-fr:fr-dinum to verify alignment with DINUM open source doctrine
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```text
/arckit-fr:fr-code-reuse Assess reuse opportunities for a French ministry citizen portal — needs: identity/authentication, document management, notification service, content management, API gateway

/arckit-fr:fr-code-reuse Code reuse assessment for 001 — DINUM digital services platform, check code.gouv.fr and SILL for dashboard, forms, and data visualisation components

/arckit-fr:fr-code-reuse Reuse assessment for a French regional council digital services platform — citizen portal, internal workflow engine, GIS mapping, document signing
```
