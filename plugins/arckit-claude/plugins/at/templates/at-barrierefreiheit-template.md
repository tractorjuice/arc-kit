...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit-at:at-barrierefreiheit`
>
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [YYYY-MM-DD] | ArcKit AI | Initial creation from `/arckit-at:at-barrierefreiheit` | [PENDING] | [PENDING] |
...
**Procurement handoff**: [Items whose remediation will be tendered — carry the conformance target into `/arckit-at:at-bvergg`]
...
**Generated by**: ArcKit `/arckit-at:at-barrierefreiheit` command
**Generated on**: [DATE]
