...
**Gathering rules** — the one-message interview in `${CLAUDE_PLUGIN_ROOT}/references/interview-pattern.md`:
...
- **Fallback**, `${CLAUDE_PLUGIN_ROOT}/templates/backlog-template.md`
