...
4. **Classification set** -- A valid value for the active classification scheme: UK (PUBLIC / OFFICIAL / OFFICIAL-SENSITIVE / SECRET), UAE Smart Data (Open / Shared / Confidential / Secret / Top Secret), or AT InfoSiG (Offen / Eingeschränkt / Vertraulich / Geheim / Streng geheim).
