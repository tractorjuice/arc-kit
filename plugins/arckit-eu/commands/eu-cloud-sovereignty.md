...
Next steps:
1. {If French dimension: Run /arckit:fr-secnumcloud for security qualification cross-check}
2. {If NIS2 in scope: Run /arckit:eu-nis2 to map SOV-7 onto Article 21}
