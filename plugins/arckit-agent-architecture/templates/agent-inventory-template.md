...
|--------|-----------|------|
| ADMP | [Architecture Design and Migration Plan] | `ARC-{P}-ADMP-v{VER}` |
| APP | [Architecture Principles] | `ARC-000-APP-v{VER}` |
| PRIN | [Principles] | `ARC-000-PRIN-v{VER}` |
| AAGR | [Agent Governance Requirements] | `ARC-{P}-AAGR-v{VER}` |
| AAOV | [Agent Operational View] | `ARC-{P}-AAOV-v{VER}` |
| AASE | [Agent Security Evaluation] | `ARC-{P}-AASE-v{VER}` |
