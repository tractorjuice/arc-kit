...
1. **Reads your project context.** Requirements, stakeholder analysis, business case — extracting the sector, organisation type, TRL level, budget range, and compliance requirements that determine eligibility.
...
3. **Gathers live data.** Every funding amount, deadline, and eligibility criterion comes from live web searches — not stale general knowledge. The agent typically makes 30-50 web searches across funding body websites, competition pages, and GrantNav.
...
- GDS Modern Digital Government Funding Pilots — the project is a textbook exemplar of the government's Modern Digital Government agenda
- NHS Digital Tools Funding (£48M nationally via ICBs) — explicitly covers cross-organisational appointment booking solutions
- NHS Unified Tech Fund (part of £7.4bn to 2030) — £2.5bn allocated to patient-facing digital services

**Four Medium-scoring opportunities:**
- Innovate UK Secure Software for Resilient Growth (£250K-£750K, deadline 29 April) — frame the platform as a Software Security Code of Practice demonstrator, partner with a security-specialist SME
- Knowledge Transfer Partnership (£102K-£306K, rolling) — fund academic collaboration for UX research and GDS service assessment preparation
- Frontier AI Discovery Phase 1 (£25K-£50K, with Phase 2 at £5M-£10M) — feasibility study on AI-powered appointment scheduling
- NIHR i4i FAST (£50K-£100K) — health-specific digital intervention funding

**Five Low-scoring grants** filtered out as poor fit — startup-focused accelerators, micro-business funds, digital twin programmes.
...
Most grant searches start and end with the big national bodies. 360Giving's GrantNav database is the hidden advantage. It aggregates published grant data from over 200 UK funders — local authority innovation funds, regional growth programmes, sector-specific trusts, and smaller foundations that don't appear on Innovate UK's radar.
