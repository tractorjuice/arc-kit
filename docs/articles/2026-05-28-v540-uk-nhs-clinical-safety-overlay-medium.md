![ArcKit v5.4 UK NHS Clinical Safety Overlay launch hero. The second sector overlay. NHS Clinical Safety. Eight jurisdiction-overlay chips along the top, a dimmed YESTERDAY arckit-uk-finance card and a brighter TODAY arckit-uk-nhs card on the sector axis, and a four-row command panel listing the SAFETY DCB0129, SAFETY DCB0160, NHSDTAC, and NHSMDR commands with their regulatory anchors.](https://arckit.org/articles/2026-05-28-v540-uk-nhs-clinical-safety-overlay-hero.png)

# ArcKit v5.4: NHS Clinical Safety, the Second Sector Overlay

ArcKit v5.4 ships today. It adds the second sector-specific community overlay, NHS clinical safety and UK / EU medical device classification, following the UK Finance Payments overlay that opened the sector axis the day before. The marketplace grows from 9 plugins to 10. The total command count grows from 139 to 143.
...
Dr Marcus Baw's [SAFETY.md spec](https://github.com/pacharanero/SAFETY.md) is the de facto open standard for representing NHS clinical safety cases as markdown files in a Git repository. It is in active use across NHS digital teams, RCPCH, openEHR, and a chain of earlier work at turva-uk and Baw Medical. It defines a three file structure (`SAFETY.md` as the human-readable index and risk management plan, `SAFETY-CASE.md` as the GSN-inspired safety argument, `HAZARD-LOG.md` as the YAML-frontmatter-and-rendered-table hazard register) that any tooling built around clinical safety in NHS digital can read.
...
The [overlay maintenance guide and full citation register](https://github.com/tractorjuice/arc-kit/blob/main/docs/guides/uk-nhs-clinical-safety-overlay.md) is the place to start. Per command guides sit alongside it: [DCB0129 manufacturer](https://github.com/tractorjuice/arc-kit/blob/main/docs/guides/uk-nhs-dcb0129.md), [DCB0160 deployer](https://github.com/tractorjuice/arc-kit/blob/main/docs/guides/uk-nhs-dcb0160.md), [DTAC v3](https://github.com/tractorjuice/arc-kit/blob/main/docs/guides/uk-nhs-dtac.md), and [UK MDR / EU MDR classification](https://github.com/tractorjuice/arc-kit/blob/main/docs/guides/uk-mdr-classification.md). The SAFETY.md spec lives at [github.com/pacharanero/SAFETY.md](https://github.com/pacharanero/SAFETY.md).
