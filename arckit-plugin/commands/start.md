...
Run `${CLAUDE_PLUGIN_ROOT}/scripts/bash/list-projects.sh --json` to get a machine-readable project inventory. Parse the JSON output and display a compact summary:
