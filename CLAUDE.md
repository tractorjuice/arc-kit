...
ArcKit is an **Enterprise Architecture Governance & Vendor Procurement Toolkit** providing 52 slash commands for AI coding assistants (Claude Code, Codex CLI, Gemini CLI, OpenCode CLI) to generate architecture artifacts. It transforms architecture governance from scattered documents into a systematic, template-driven process.
