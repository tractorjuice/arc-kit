...
- `.claude/commands/arckit.*.md` - 28 slash commands for Claude Code (frontmatter + prompt)
...
ArcKit's primary interface is **28 slash commands** that generate architecture artifacts:
