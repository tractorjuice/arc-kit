#!/usr/bin/env node
/**
 * Tests for the research-handoff JSON Schema, exercised through the shared
 * plugins/arckit-claude/scripts/validate-handoff.mjs validator.
 *
 * Each fixture in tests/plugin/fixtures/research-handoff/ is run through
 ...
 *
 * Run: node tests/plugin/test_validate_research_handoff.mjs
 */
...
const schema = resolve(repoRoot, 'plugins/arckit-claude/schemas/research-handoff.schema.json');
const fixturesDir = resolve(__dirname, 'fixtures/research-handoff');
