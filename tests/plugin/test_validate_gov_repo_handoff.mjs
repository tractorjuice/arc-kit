#!/usr/bin/env node
/**
 * Tests for the gov-repo-handoff JSON Schema, exercised through the shared
 * plugins/arckit-claude/scripts/validate-handoff.mjs validator.
 *
 * Each fixture in tests/plugin/fixtures/gov-repo-handoff/ is run through
 ...
 *
 * Run: node tests/plugin/test_validate_gov_repo_handoff.mjs
 */
...
const schema = resolve(repoRoot, 'plugins/arckit-claude/schemas/gov-repo-handoff.schema.json');
const fixturesDir = resolve(__dirname, 'fixtures/gov-repo-handoff');
