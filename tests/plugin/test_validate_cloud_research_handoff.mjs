#!/usr/bin/env node
/**
 * Tests for the cloud-research-handoff JSON Schema, exercised through the shared
 * plugins/arckit-claude/scripts/validate-handoff.mjs validator.
 *
 * Each fixture in tests/plugin/fixtures/cloud-research-handoff/ is run through
 ...
 *
 * Run: node tests/plugin/test_validate_cloud_research_handoff.mjs
 */
...
const schema = resolve(repoRoot, 'plugins/arckit-claude/schemas/cloud-research-handoff.schema.json');
const fixturesDir = resolve(__dirname, 'fixtures/cloud-research-handoff');
