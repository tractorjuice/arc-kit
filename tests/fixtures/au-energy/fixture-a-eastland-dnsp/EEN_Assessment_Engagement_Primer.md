...
EEN is a designated critical electricity asset, an AEMO market participant, and an AER-regulated DNSP running an unregulated arm — all at once, mid-transition on a large IT/OT-convergent program portfolio. The obligations have stacked up faster than the evidence base.

- **Convergence first.** ADMS, DERMS and the data platform have fused OT and IT; the assessment treats that seam as the central risk theme.
- **Compliance as licence to operate.** SOCI/CIRMP, AESCSF and ring-fencing are not optional — they need to be demonstrably true, not just documented.
...
4. Ring-fencing Integrity (enforced information flows)
