...
Read 2-3 existing official templates from `.arckit/templates/` to understand the standard format:

- Always read `.arckit/templates/requirements-template.md` (canonical example of Document Control + structure)
