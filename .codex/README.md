...
/prompts:arckit.adr Document architectural decisions with MADR format and UK Government compliance
...
- 48 slash commands for complete architecture lifecycle
