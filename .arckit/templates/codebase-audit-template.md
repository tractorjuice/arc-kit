...
> **Template Origin**: Community | **ArcKit Version**: [VERSION] | **Command**: `/arckit:repo-audit`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [DATE] | ArcKit AI | Initial creation from `/arckit:repo-audit` command | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit:repo-audit` command
**Generated on**: [DATE]
