...
> **Template Origin**: Official | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk:uk-gcloud-search`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [DATE] | ArcKit AI | Initial creation from `/arckit-uk:uk-gcloud-search` command | PENDING | PENDING |
...
- [Gap 1 - run /arckit-uk:uk-gcloud-clarify]
- [Gap 2]
...
2. **Gap analysis**: Run `/arckit-uk:uk-gcloud-clarify` to generate clarification questions
...
- **`/arckit-uk:uk-gcloud-clarify`**: Generate clarification questions for shortlisted services
- **`/arckit.evaluate`**: Create vendor evaluation framework and scoring
- **`/arckit-uk:uk-dos`**: If custom development needed instead of cloud services
...
**Generated by**: ArcKit `/arckit-uk:uk-gcloud-search` command
**Generated on**: [DATE]
