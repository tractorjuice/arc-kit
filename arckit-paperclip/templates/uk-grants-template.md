...
> **Template Origin**: Official | **ArcKit Version**: [VERSION] | **Command**: `/arckit-uk:uk-grants`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [DATE] | ArcKit AI | Initial creation from `/arckit-uk:uk-grants` agent | PENDING | PENDING |
...
**Generated by**: ArcKit `/arckit-uk:uk-grants` command
**Generated on**: [DATE]
